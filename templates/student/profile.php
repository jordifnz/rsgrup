  ...
  <div class="container container--narrow">
    ...
    <form action="<?= BASE_URL ?>/perfil/guardar" method="POST" enctype="multipart/form-data" class="form">
      ...
      <div class="avatar-editor">
        ...
        <?php else: ?>
          <div class="avatar-initials avatar-lg"><?= htmlspecialchars(substr($user['name'],0,1) . substr($user['surnames'],0,1)) ?></div>
        <?php endif; ?>
        <label class="btn btn-sm" for="avatar">Cambiar foto</label>
      ...
      <p class="text-muted text-sm">Deja en blanco si no quieres cambiarla</p>
      <div class="form-grid">
